...
module counter(clk, rst_n, sel, out);
  ...
  wire [3:0] out;
  wire [3:0] next_val;
  wire UNCONNECTED_HIER_Z, n_1, n_2, n_3, n_4, n_6, n_7, n_8;
  wire n_9, n_10, n_11, n_12;
  DFF ff_inst(.in ({next_val[3:1], UNCONNECTED_HIER_Z}), .clk (clk),
       .rst_n (rst_n), .out (out));
  ...
  sky130_fd_sc_hd__nand4_2 g149(.A (n_10), .B (n_8), .C (n_7), .D
       (n_6), .Y (n_11));
  sky130_fd_sc_hd__clkinv_2 g150(.A (n_9), .Y (n_10));
  sky130_fd_sc_hd__nand2_2 g151(.A (n_3), .B (n_4), .Y (n_9));
  sky130_fd_sc_hd__nand2b_1 g152(.A_N (sel), .B (out[2]), .Y (n_8));
  sky130_fd_sc_hd__nand2b_1 g153(.A_N (out[2]), .B (out[1]), .Y (n_7));
  sky130_fd_sc_hd__nand2_1 g154(.A (out[1]), .B (n_1), .Y (n_4));
  sky130_fd_sc_hd__nand2_1 g155(.A (n_2), .B (out[0]), .Y (n_3));
